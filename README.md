...
| | 𖧹 Used SQL and Power BI to analyze students debt and identify crisis risks <br> 𖧹 Flagged vulnerable segments based on debt-to-income ratios and weak financial profiles <br> 𖧹 Helped teams make smarter decisions by sharing clear, actionable insights <br> 𖧹 Protected the firm from ~0.8% potential losses through early risk detection <br> 𖧹 Created visualizations that increased client engagement and satisfaction by 10% |
